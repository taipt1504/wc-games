...
> **Related Service Designs**: [Prediction & Scoring (full)](./2026-05-30-prediction-scoring-service-design.md) · [Auth & Account](./2026-05-30-auth-account-service-design.md) · [Data + AI/Pipeline](./2026-05-30-data-ai-pipeline-service-design.md) · [Supporting modules](./2026-05-30-supporting-modules-service-design.md)
...
| 3 | Phụ thuộc gateway 9router | Low | Med | 9router **đã self-host sẵn** (team quản lý); app kết nối qua **env config** + bọc sau interface `LlmGateway` (đổi được); xem [ADR-0005](./decisions/ADR-0005-9router-gateway.md) |
...
| # | Question | Status |
|---|---|---|
| SD-01 | Tích hợp 9router | ✅ Resolved — 9router đã deploy sẵn; app kết nối qua **env config** (`LLM_GATEWAY_*`, xem ADR-0005) |
...
└── Service Designs:
    ├── ⭐ FULL  → 2026-05-30-prediction-scoring-service-design.md
    ├── medium   → 2026-05-30-auth-account-service-design.md
    ├── medium   → 2026-05-30-data-ai-pipeline-service-design.md
    └── light    → 2026-05-30-supporting-modules-service-design.md (Lobby/Engagement/Social/Admin&Risk/News)
```
