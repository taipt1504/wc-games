...
const T: [string, string, string, number, [string, string, string]][] = [
  ...
  ['South Africa', 'RSA', 'CAF', 57, ['#007a4d', '#ffb612', '#de3831']],
  ['South Korea', 'KOR', 'AFC', 22, ['#ffffff', '#cd2e3a', '#0047a0']],
  ['Czech Republic', 'CZE', 'UEFA', 36, ['#d7141a', '#ffffff', '#11457e']],
  ['Canada', 'CAN', 'CONCACAF', 50, ['#ff0000', '#ffffff', '#ff0000']],
  ['Bosnia and Herzegovina', 'BIH', 'UEFA', 50, ['#002f6c', '#ffcd00', '#ffffff']],
  ...
  ['Haiti', 'HAI', 'CONCACAF', 83, ['#00209f', '#ffffff', '#d21034']],
  ...
  ['Curaçao', 'CUW', 'CONCACAF', 90, ['#002b7f', '#f9e300', '#002b7f']],
  ...
  ['Sweden', 'SWE', 'UEFA', 27, ['#006aa7', '#fecc00', '#006aa7']],
  ...
  ['Cape Verde', 'CPV', 'CAF', 71, ['#003893', '#ffffff', '#cf2027']],
  ...
  ['Iraq', 'IRQ', 'AFC', 58, ['#ce1126', '#ffffff', '#000000']],
  ...
  ['DR Congo', 'COD', 'CAF', 60, ['#007fff', '#f7d618', '#ce1021']],
...
const FLAG_ISO_BY_CODE: Record<string, string> = {
  ALG: 'dz', ARG: 'ar', AUS: 'au', AUT: 'at', BEL: 'be', BIH: 'ba', BRA: 'br', CAN: 'ca', CIV: 'ci', COD: 'cd',
  COL: 'co', CPV: 'cv', CRO: 'hr', CUW: 'cw', CZE: 'cz', ECU: 'ec', EGY: 'eg', ENG: 'gb-eng', ESP: 'es', FRA: 'fr',
  GER: 'de', GHA: 'gh', HAI: 'ht', IRN: 'ir', IRQ: 'iq', JOR: 'jo', JPN: 'jp', KOR: 'kr', KSA: 'sa', MAR: 'ma',
  MEX: 'mx', NED: 'nl', NOR: 'no', NZL: 'nz', PAN: 'pa', PAR: 'py', POR: 'pt', QAT: 'qa', RSA: 'za', SCO: 'gb-sct',
  SEN: 'sn', SUI: 'ch', SWE: 'se', TUN: 'tn', TUR: 'tr', URU: 'uy', USA: 'us', UZB: 'uz',
};
const flagUrl = (code: string): string => `https://flagcdn.com/w80/${FLAG_ISO_BY_CODE[code] ?? code.toLowerCase()}.png`;

export const teams: Team[] = T.map((t, i) => ({
  id: i, name: t[0], code: t[1], conf: t[2], rank: t[3], colors: t[4], flagUrl: flagUrl(t[1]),
